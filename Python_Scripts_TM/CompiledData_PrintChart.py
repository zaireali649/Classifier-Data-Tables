# -*- coding: utf-8 -*-
"""
Created on Wed Jul 26 12:07:17 2017
...
def printRocCurve(f, classifications, score, test, isPlot):
...
def printChart(f, clf, isPlot):
    ...
    f.write("User, Accuracy, F-Score, Precision, Recall")
    f.write("\n")
    
    
    for userNumber in range(0, 32):
    ...
    ################################################################################################################ 
        ...
        for i in range(len(allClassifications2)):
         ...
         # the delimiter. 
        classReport = classification_report(allClassifications,allPredictions, digits=6)
...
#==============================================================================
        ...
        f.write(str(userNumber) + ", " + ("%.6f"%accuracy_score(allClassifications,allPredictions)) + ", " + str(f1_score(allClassifications,allPredictions, average='macro')) + ", " + str(precision_score(allClassifications,allPredictions, average='macro')) + ", " + str(recall_score(allClassifications,allPredictions, average='macro')))
        f.write('\n')   
        
        #printRocCurve(f, classifications, score, test, isPlot)
