...
Note: This is for one user (user # can be changed with userNumber) and it is
to be run using the command line. 
...
import printDataTables_OneUser_Command
...
def logRegression(C, penalty, tolerance, isPlot):
     ...
     printDataTables_OneUser_Command.printChart(f, clf, isPlot)     
